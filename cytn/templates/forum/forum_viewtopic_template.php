...
$FORUM_VIEWTOPIC_TEMPLATE['thread'] = "
									<li id='post-{POSTID}' class='forum-viewtopic-post'>
										<div class='hidden-xs row row-fluid btn-navbar navbar-btn'>
												...
												<div class='col-xs-3 col-sm-3 left text-left'>
													<div class='row'>
														<div class='col-xs-12 col-md-12 forum-user-combo'>{USERCOMBO}<br />{CUSTOMTITLE}</div>
													</div>

												{NEWFLAG} {ANON_IP}</div>
												<div class='col-xs-3 col-sm-3 text-muted text-muted muted'><small>{THREADDATESTAMP=relative}</small></div>
												<div class='col-xs-4 col-sm-4 text-muted text-muted muted right text-right'><small>{LASTEDIT}{LASTEDITBY=link}</small></div>
												<div class='col-xs-2 col-sm-2 span1 right text-right'>{POSTOPTIONS}</div>
