...
// Thread info
define('IMAGE_e', 					'<img src="'.e_THEME_ABS.'cytn/forum/e.png" alt="" title="" />');
...
define('IMAGE_email', 	'<img src="'.e_THEME_ABS.'cytn/forum/email.png" alt="'.LAN_FORUM_2044.'" title="'.LAN_FORUM_2044.'" />');
define('IMAGE_profile', '<img src="'.e_THEME_ABS.'cytn/forum/profile.png" alt="'.LAN_FORUM_4007.'" title="'.LAN_FORUM_4007.'" />');

// action
define('IMAGE_pm', 			'<img src="'.img_path('pm.png').'" alt="'.LAN_FORUM_4008.'" title="'.LAN_FORUM_4008.'" class="icon S16 action" />');
define('IMAGE_edit', 		'<img src="'.e_THEME_ABS.'cytn/forum/edit.png" alt="'.LAN_EDIT.'" title="'.LAN_EDIT.'" class="icon S16 action" />');
define('IMAGE_quote', 		'<img src="'.e_THEME_ABS.'cytn/forum/quote.png" alt="'.LAN_FORUM_2041.'" title="'.LAN_FORUM_2041.'" class="icon S16 action" />');
...
define('IMAGE_newthread',				'<img src="'.e_THEME_ABS.'cytn/forum/newthread.png" alt="'.LAN_FORUM_2005.'" title="'.LAN_FORUM_2005.'" />');
define('IMAGE_reply',					'<img src="'.e_THEME_ABS.'cytn/forum/reply.png" alt="'.LAN_FORUM_2006.'" title="'.LAN_FORUM_2006.'" />');
